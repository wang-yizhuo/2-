...
int main()
{
   ...
   if(dui1==5) d21=blackdata[0];
	...
	int k1=0,k2=0,k=0;i=0;
	if(hua1==0&&shun1==0&&dui1==0) k1=0;
	if(hua1==0&&shun1==0&&dui1==1) k1=1;
	if(hua1==0&&shun1==0&&dui1==2) k1=2;
	if(hua1==0&&shun1==0&&dui1==3) {
	   if(dui12==1) k1=4;
	   else k1=3;}
	if(hua1==0&&shun1==0&&dui1==4) k1=5;
	if(hua1==0&&shun1==0&&dui1==5) k1=6;
	if(hua1==0&&shun1==1&&dui1==0) k1=7;
	if(hua1==1&&shun1==0&&dui1==0) k1=8;
	if(hua1==1&&shun1==1&&dui1==0) k1=9;
	
	if(hua2==0&&shun2==0&&dui2==0) k2=0;
	if(hua2==0&&shun2==0&&dui2==1) k2=1;
	if(hua2==0&&shun2==0&&dui2==2) k2=2;
	if(hua2==0&&shun2==0&&dui2==3) {
	   if(dui22==1) k2=4;
	   else k2=3;}
	if(hua2==0&&shun2==0&&dui2==4) k2=5;
	if(hua2==0&&shun2==0&&dui2==5) k2=6;
	if(hua2==0&&shun2==1&&dui2==0) k2=7;
	if(hua2==1&&shun2==0&&dui2==0) k2=8;
	if(hua2==1&&shun2==1&&dui2==0) k2=9;
	if(k1>k2)  printf("Black wins");
	if(k2>k1) printf("White wins");
	if(k1==k2) {if(d11>d21) printf("Black wins");
	    if(d21>d11) printf("White wins");
	    if(d11==d21) {if(d12>d22) printf("Black wins");
	        if(d22>d12) printf("White wins");
  	        if(d22==d12) {for(i=0;i<=4;i++){
  	        	if(data1[i]<data2[i]) {
  	        		k=1;printf("White wins");break;
				  }
				if(data1[i]>data2[i]) {
  	        		k=1;printf("Black wins");break;
				  }
  	        	}
  	        if(k==0) printf("Tie");
	        }
